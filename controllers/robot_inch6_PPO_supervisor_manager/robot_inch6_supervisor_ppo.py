...
class RobotInch6Supervisor(RobotSupervisorEnv):
    ...
    def __init__(self):
        ...
        for i in range(3):
            ...
            motor = self.getDevice(name)	 # Get the motor handle
    ...
    def solved(self):
        ...
        return (len(self.episode_score_list) > 500 and
               np.mean(self.episode_score_list[-500:]) > -3)
    ...
    def apply_action(self, action):
        ...
        for i in range(3):
            ...
            motor_position = self.motor_position_values[i] + delta
