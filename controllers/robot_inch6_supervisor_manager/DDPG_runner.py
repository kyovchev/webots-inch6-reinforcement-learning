...
def run(load_path):
    ...
    # We pass (6, ) as numberOfInputs and (3, ) as numberOfOutputs, taken from the gym spaces
    agent = DDPGAgent(alpha=0.000025,
                      beta=0.00025,
    ...
    while not solved and episode_count < EPISODE_LIMIT:
        ...
        for step in range(STEPS_PER_EPISODE):
            ...
            # Step the supervisor to get the current selectedAction reward, the new state
